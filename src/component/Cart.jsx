...
const Cart = () => {
  const activeNavbar =
    "fixed right-0 top-0 w-[65%] md:w-[18%] h-full bg-white ease-in-out duration-500 z-20 shadow-2xl";
  const normalNavbar =
    "left-[-100%] top-0 w-[55%] h-full bg-white ease-in-out duration-500 fixed";
