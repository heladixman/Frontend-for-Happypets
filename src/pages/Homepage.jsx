          ...
          <div className="my-5">
            <div>
              <div className="flex justify-center p-2">
                <button className="rounded-full py-2 px-4 bg-gray-100 hover:bg-gray-200 mx-2">
                  Premium Food
                </button>
                <button className="rounded-full py-2 px-4 bg-gray-100 hover:bg-gray-200 mx-2">
                  Cat Suits
          ...
          <div className="flex flex-wrap justify-between">
            {filterMenProduct.map((product, key) => {
              return (
                <div
                  key={key}
                  className="mb-3 max-w-[48%] lg:w-[18%] md:w-[30%] bg-white roun7ded-2xl"
                >
        ...
        <div className="p-10 w-full bg-card1 rounded-3xl my-5">
          <div className="flex justify-between">
            <div className="px-6 py-4 w-3/4 md:w-[600px] m-auto">
              <div className="md:font-bold font-normal md:text-3xl text-lg font-nunito">
                Hari Kebersamaan
              </div>
              <p className="text-gray-700 md:text-base text-sm">
                Rayakan hari kebersamaan seperti ulang tahunnya, banyak
                kejutannya banyak diskonnya. Booking sekarang!
              </p>
              <button className="text-white bg-card-grad2 font-medium shadow-lg hover: rounded-xl text-sm px-5 py-2.5 mt-3 text-center">
                Book a Schedule
              </button>
            </div>
