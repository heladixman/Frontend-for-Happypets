      ...
      <div className="flex w-full py-24 justify-center">
        <div className="w-full p-6 rounded-md lg:max-w-xl shadow-none lg:shadow-xl">
          ...
          <form className="mt-6">
            ...
            <a href="#" className="text-xs text-card-grad2 hover:underline">
              Forget Password?
            </a>
            <div className="mt-6">
              <button
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-card2 rounded-md hover:bg-card1 focus:outline-none focus:bg-card2"
                type="submit"
              >
                Sign In
              </button>
          ...
          <p className="mt-8 text-xs font-light text-center text-gray-700">
            ...
            <a href="#" className="font-medium text-card-grad2 hover:underline">
              Sign up
            </a>
          </p>
