        ...
        <div className='flex flex-wrap justify-between'>
          {
            filterItemsforProduct.map((item, key)=> {
              return(
                <div key={key} className="mb-3 max-w-[48%] lg:w-[18%] md:w-[30%] bg-white rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 border-1">
                  <a href={`/marketplace/product/${item.productUrl}`}>
                  <div className="bg-white max-w-sm ">
                    <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/184.jpg" alt=""/>
                    <div className="p-4 bg-white rounded-b-lg "> 
                      <p className="text-gray-900 font-bold text-xs uppercase">category</p>
                      <p className="text-gray-700 text-sm truncate">{item.itemName}</p>
